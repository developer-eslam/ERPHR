...
public class detailsthemefour_receclerview   extends RecyclerView.Adapter<detailsthemefour_receclerview.Holder> {
    ...
    int N;
    int i;
    public detailsthemefour_receclerview( Context context,List<personalappliactionmodel>personalappliactionmodels){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.details_fragment_four,parent,false);
