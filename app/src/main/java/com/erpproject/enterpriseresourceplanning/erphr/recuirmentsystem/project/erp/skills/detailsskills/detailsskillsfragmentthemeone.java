...
public class detailsskillsfragmentthemeone  extends RecyclerView.Adapter<detailsskillsfragmentthemeone.Holder> {
    ...
    public void createpdffile(){
        ...
        try {
            ...
            paragraph.add("Skill:"+ Chunk.NEWLINE );
    ...
    int N;
    int i;
    public detailsskillsfragmentthemeone( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsskillsthemeone,parent,false);
