package com.erpproject.enterpriseresourceplanning.erphr.recuirmentsystem.project.erp.skills.detailsskills;
...
public class detailsskillsfragmentthemefour  extends RecyclerView.Adapter<detailsskillsfragmentthemefour.Holder> {
    ...
    public void createpdffile(){
        ...
        try {
            ...
            paragraph.add("Skill:"+ Chunk.NEWLINE+ Chunk.NEWLINE );
    ...
    int N;
    int i;
    public detailsskillsfragmentthemefour( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsskillsthemefour,parent,false);
