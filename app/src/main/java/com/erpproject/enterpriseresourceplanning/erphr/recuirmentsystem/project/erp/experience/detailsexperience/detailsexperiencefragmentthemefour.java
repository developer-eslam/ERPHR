...
public class detailsexperiencefragmentthemefour  extends RecyclerView.Adapter<detailsexperiencefragmentthemefour.Holder> {
    ...
    int N;
    int i;
    public detailsexperiencefragmentthemefour( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsexperiencethemefour,parent,false);
