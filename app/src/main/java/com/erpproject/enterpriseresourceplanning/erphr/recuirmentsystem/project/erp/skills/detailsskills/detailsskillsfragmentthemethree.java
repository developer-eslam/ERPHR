...
public class detailsskillsfragmentthemethree  extends RecyclerView.Adapter<detailsskillsfragmentthemethree.Holder> {
    ...
    int N;
    int i;
    public detailsskillsfragmentthemethree( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsskillsthemethree,parent,false);
