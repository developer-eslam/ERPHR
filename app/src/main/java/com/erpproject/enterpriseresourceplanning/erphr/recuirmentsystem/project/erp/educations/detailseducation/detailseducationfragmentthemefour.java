...
public class detailseducationfragmentthemefour  extends RecyclerView.Adapter<detailseducationfragmentthemefour.Holder> {
    ...
    public detailseducationfragmentthemefour(Context context,List<educationmodel>educationmodels){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_detailseducationfragmentthemefour,parent,false);
