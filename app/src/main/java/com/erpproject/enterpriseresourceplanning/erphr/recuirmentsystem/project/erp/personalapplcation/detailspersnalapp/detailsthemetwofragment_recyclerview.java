...
public class detailsthemetwofragment_recyclerview  extends RecyclerView.Adapter<detailsthemetwofragment_recyclerview.Holder> {
    ...
    int N;
    int i;
    public detailsthemetwofragment_recyclerview( Context context,List<personalappliactionmodel>personalappliactionmodels){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.details_fragment_two,parent,false);
