...
public class detailsexperiencefragmentthemethree  extends RecyclerView.Adapter<detailsexperiencefragmentthemethree.Holder> {
    ...
    int N;
    int i;
    public detailsexperiencefragmentthemethree( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsexperiencethemethree,parent,false);
