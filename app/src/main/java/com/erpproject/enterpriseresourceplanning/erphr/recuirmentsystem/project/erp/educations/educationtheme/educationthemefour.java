...
import com.erpproject.enterpriseresourceplanning.erphr.recuirmentsystem.project.erp.educations.detailseducation.detailseducationfragmentthemefour;
...
public class educationthemefour   extends Activity {

    RecyclerView recyclerView;
    com.erpproject.enterpriseresourceplanning.erphr.recuirmentsystem.project.erp.educations.detailseducation.detailseducationfragmentthemefour detailseducationfragmentthemefour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailseducationfragmentthemefour = new detailseducationfragmentthemefour(getApplicationContext(),educationmodelList(1));

        recyclerView.setAdapter(detailseducationfragmentthemefour);
