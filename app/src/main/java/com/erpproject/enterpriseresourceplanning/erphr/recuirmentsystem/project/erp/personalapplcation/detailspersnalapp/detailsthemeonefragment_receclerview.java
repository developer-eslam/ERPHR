...
public class detailsthemeonefragment_receclerview extends RecyclerView.Adapter<detailsthemeonefragment_receclerview.Holder> {
    ...
    public void insertitemsinpdffile(){
        ...
        if(textIn.getText().toString().isEmpty()){
            ...
            for( i=0;i<N;i++){
                ...
                text.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.stylee));
    ...
    public void createpdffile(){
        Rectangle rect= new Rectangle(613,793);


        rect.setBorder(Rectangle.BOX);
        rect.setBorderWidthRight(5);
        rect.setBorderWidthLeft(5);
        rect.setBorderWidthBottom(5);
        rect.setBorderWidthTop(5);
            ...
            for (int m = 0; m <= N; m++) {
                ...
                document.add(new Paragraph(
                        " " + " " + " " + " " + " " + " " + " " +
                                ...
                                " " + " " + " " + " " + " " + " " + " " +
                                " " + " " + " " + " " + " " + " " + " " +
                                editTextList.get(m).getText().toString()+ Chunk.NEWLINE+ Chunk.NEWLINE));
            }
            document.close();
    ...
    public detailsthemeonefragment_receclerview(Context context, List<personalappliactionmodel> personalappliactionmodels) {
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.details_fragment_one, parent, false);
    ...
    private void setBackground(Document document) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.baabbaba);
