...
import com.erpproject.enterpriseresourceplanning.erphr.recuirmentsystem.project.erp.educations.detailseducation.detailseducationfragmentthemfive;
...
public class educationthemefive  extends Activity {

    RecyclerView recyclerView;
    com.erpproject.enterpriseresourceplanning.erphr.recuirmentsystem.project.erp.educations.detailseducation.detailseducationfragmentthemfive detailseducationfragmentthemfive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailseducationfragmentthemfive = new detailseducationfragmentthemfive(getApplicationContext(),educationmodelList(1));

        recyclerView.setAdapter(detailseducationfragmentthemfive);
