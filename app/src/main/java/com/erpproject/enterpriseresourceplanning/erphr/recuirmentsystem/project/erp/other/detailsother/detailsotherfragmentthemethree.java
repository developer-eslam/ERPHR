...
public class detailsotherfragmentthemethree  extends RecyclerView.Adapter<detailsotherfragmentthemethree.Holder> {
    ...
    int N;
    int i;
    public detailsotherfragmentthemethree( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsotherthemethree,parent,false);
