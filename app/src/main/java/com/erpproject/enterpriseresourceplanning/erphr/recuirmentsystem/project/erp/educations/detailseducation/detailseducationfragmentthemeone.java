...
public class detailseducationfragmentthemeone extends RecyclerView.Adapter<detailseducationfragmentthemeone.Holder> {
    ...
    LinearLayout layout;
    @OnClick(R.id.add)
    public void insertdatainpdffile() {
   ...
   @OnClick(R.id.createpdf)
    public void createpdffile(){
        ...
        try {
            ...
            paragraph.add(educationmodel.DEGREE_MAJOR );
    ...
    int N;
    int i;
    public detailseducationfragmentthemeone( Context context,List<educationmodel>educationmodels){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_detailseducationfragmentthemeone,parent,false);
