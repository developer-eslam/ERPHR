...
public class detialeducationthemetwo  extends RecyclerView.Adapter<detialeducationthemetwo.Holder> {
    ...
    @OnClick(R.id.createpdf)
     public void createpdffile(){
        ...
        try {
            ...
            paragraph.add(educationmodel.DEGREE_MAJOR +Chunk.NEWLINE);
    ...
    int N;
    int i;
    public detialeducationthemetwo( Context context,List<educationmodel>educationmodels){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailseducationthemetwo,parent,false);
