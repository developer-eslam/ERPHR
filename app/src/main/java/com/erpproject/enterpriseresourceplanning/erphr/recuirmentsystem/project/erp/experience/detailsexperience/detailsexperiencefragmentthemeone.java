...
public class detailsexperiencefragmentthemeone  extends RecyclerView.Adapter<detailsexperiencefragmentthemeone.Holder> {
    ...
    public void createpdffile(){
        ...
        try {
            ...
            paragraph.add("Experience:"+ Chunk.NEWLINE );
    ...
    int N;
    int i;
    public detailsexperiencefragmentthemeone( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsexperiencethemeone,parent,false);
