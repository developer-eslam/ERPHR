...
public class detailsotherfragmentthemeone  extends RecyclerView.Adapter<detailsotherfragmentthemeone.Holder> {
    ...
    public void createpdffile(){
        ...
        try {
            ...
            paragraph.add("Other:"+ Chunk.NEWLINE );
    ...
    int N;
    int i;
    public detailsotherfragmentthemeone( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsotherthemeone,parent,false);
