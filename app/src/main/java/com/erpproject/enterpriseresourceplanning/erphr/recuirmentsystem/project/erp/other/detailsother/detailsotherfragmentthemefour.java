package com.erpproject.enterpriseresourceplanning.erphr.recuirmentsystem.project.erp.other.detailsother;
...
public class detailsotherfragmentthemefour  extends RecyclerView.Adapter<detailsotherfragmentthemefour.Holder> {
    ...
    public void insertitemsinpdffile(){
        ...
        if(textIn.getText().toString().isEmpty()){
            ...
            for (i = 0; i < N; i++) {
                ...
                text.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.style4));
    ...
    public void createpdffile(){
        ...
        String outpath = Environment.getExternalStorageDirectory()+"/other.pdf";
        ...
        try {
            ...
            paragraph.add("Other:"+ Chunk.NEWLINE+ Chunk.NEWLINE );
    ...
    int N;
    int i;
    public detailsotherfragmentthemefour( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsotherthemefour,parent,false);
    ...
    private void setBackground(Document document) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.nh);
