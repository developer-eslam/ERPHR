...
public class detailsotherfragmentthemetwo  extends RecyclerView.Adapter<detailsotherfragmentthemetwo.Holder> {
    ...
    int N;
    int i;
    public detailsotherfragmentthemetwo( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsotherthemetwo,parent,false);
