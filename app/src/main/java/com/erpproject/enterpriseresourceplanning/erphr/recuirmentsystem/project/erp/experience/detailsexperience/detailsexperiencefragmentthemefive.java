...
public class detailsexperiencefragmentthemefive  extends RecyclerView.Adapter<detailsexperiencefragmentthemefive.Holder> {
    ...
    int N;
    int i;
    public detailsexperiencefragmentthemefive( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsexperiencethemefive,parent,false);
