...
public class detailsotherfragmentthemefive  extends RecyclerView.Adapter<detailsotherfragmentthemefive.Holder> {
    ...
    int N;
    int i;
    public detailsotherfragmentthemefive( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsotherthemefive,parent,false);
