...
public class detailsskillsfragmentthemefive  extends RecyclerView.Adapter<detailsskillsfragmentthemefive.Holder> {
    ...
    int N;
    int i;
    public detailsskillsfragmentthemefive( Context context){
    ...
    public Holder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detailsskillsthemefive,parent,false);
